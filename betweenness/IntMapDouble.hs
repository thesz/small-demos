...
module IntMapDouble (
            -- * Map type
              IntMapDouble(..), Key          -- instance Eq,Show
...
data IntMapDouble = Bin {-# UNPACK #-} !Prefix {-# UNPACK #-} !Mask !(IntMapDouble) !(IntMapDouble)
              | Tip {-# UNPACK #-} !Key !Double
              | Nil
...
-- | Same as 'difference'.
(\\) :: IntMapDouble -> IntMapDouble -> IntMapDouble
...
instance Monoid (IntMapDouble) where
    mempty  = empty
    mappend = union
    mconcat = unions
...
instance NFData a => NFData (IntMapDouble) where
    rnf Nil = ()
    rnf (Tip _ v) = rnf v
...
instance Data a => Data (IntMapDouble) where
...
notMember :: Key -> IntMapDouble -> Bool
notMember k m = not $ member k m

-- | /O(min(n,W))/. Lookup the value at a key in the map. See also 'Data.Map.lookup'.

-- See Note: Local 'go' functions and capturing]
lookup :: Key -> IntMapDouble -> Maybe a
lookup k = k `seq` go
  where
...
-- See Note: Local 'go' functions and capturing]
findWithDefault :: a -> Key -> IntMapDouble -> a
...
-- See Note: Local 'go' functions and capturing.
lookupLT :: Key -> IntMapDouble -> Maybe (Key, a)
...
-- See Note: Local 'go' functions and capturing.
lookupGT :: Key -> IntMapDouble -> Maybe (Key, a)
...
-- See Note: Local 'go' functions and capturing.
lookupLE :: Key -> IntMapDouble -> Maybe (Key, a)
...
-- See Note: Local 'go' functions and capturing.
lookupGE :: Key -> IntMapDouble -> Maybe (Key, a)
...
-- given, it has m > 0.
unsafeFindMin :: IntMapDouble -> Maybe (Key, a)
...
-- given, it has m > 0.
unsafeFindMax :: IntMapDouble -> Maybe (Key, a)
...
insert :: Key -> a -> IntMapDouble -> IntMapDouble
insert k x t = k `seq`
  case t of
    Bin p m l r
...
insertWith :: (a -> a -> a) -> Key -> a -> IntMapDouble -> IntMapDouble
insertWith f k x t
...
insertWithKey :: (Key -> a -> a -> a) -> Key -> a -> IntMapDouble -> IntMapDouble
...
insertLookupWithKey :: (Key -> a -> a -> a) -> Key -> a -> IntMapDouble -> (Maybe a, IntMapDouble)
...
delete :: Key -> IntMapDouble -> IntMapDouble
delete k t = k `seq`
  case t of
    Bin p m l r
      | nomatch k p m -> t
...
adjust ::  (a -> a) -> Key -> IntMapDouble -> IntMapDouble
adjust f k m
...
adjustWithKey ::  (Key -> a -> a) -> Key -> IntMapDouble -> IntMapDouble
adjustWithKey f
...
update ::  (a -> Maybe a) -> Key -> IntMapDouble -> IntMapDouble
update f
...
updateWithKey ::  (Key -> a -> Maybe a) -> Key -> IntMapDouble -> IntMapDouble
...
updateLookupWithKey ::  (Key -> a -> Maybe a) -> Key -> IntMapDouble -> (Maybe a,IntMapDouble)
...
alter :: (Maybe a -> Maybe a) -> Key -> IntMapDouble -> IntMapDouble
alter f k t = k `seq`
  case t of
    Bin p m l r
...
unions :: [IntMapDouble] -> IntMapDouble
unions xs
...
unionsWith :: (a->a->a) -> [IntMapDouble] -> IntMapDouble
unionsWith f ts
...
union :: IntMapDouble -> IntMapDouble -> IntMapDouble
union m1 m2
...
unionWith :: (a -> a -> a) -> IntMapDouble -> IntMapDouble -> IntMapDouble
unionWith f m1 m2
...
unionWithKey :: (Key -> a -> a -> a) -> IntMapDouble -> IntMapDouble -> IntMapDouble
...
difference :: IntMapDouble -> IntMapDouble -> IntMapDouble
difference m1 m2
...
differenceWith :: (a -> b -> Maybe a) -> IntMapDouble -> IntMapDouble -> IntMapDouble
...
differenceWithKey :: (Key -> a -> b -> Maybe a) -> IntMapDouble -> IntMapDouble -> IntMapDouble
...
intersection :: IntMapDouble -> IntMapDouble -> IntMapDouble
intersection m1 m2
...
intersectionWith :: (a -> b -> c) -> IntMapDouble -> IntMapDouble -> IntMapDouble
...
intersectionWithKey :: (Key -> a -> b -> c) -> IntMapDouble -> IntMapDouble -> IntMapDouble
...
mergeWithKey :: (Key -> a -> b -> Maybe c) -> (IntMapDouble -> IntMapDouble) -> (IntMapDouble -> IntMapDouble)
             -> IntMapDouble -> IntMapDouble -> IntMapDouble
...
mergeWithKey' :: (Prefix -> Mask -> IntMapDouble -> IntMapDouble -> IntMapDouble)
              -> (IntMapDouble -> IntMapDouble -> IntMapDouble) -> (IntMapDouble -> IntMapDouble) -> (IntMapDouble -> IntMapDouble)
              -> IntMapDouble -> IntMapDouble -> IntMapDouble
...
updateMinWithKey :: (Key -> a -> Maybe a) -> IntMapDouble -> IntMapDouble
...
updateMaxWithKey :: (Key -> a -> Maybe a) -> IntMapDouble -> IntMapDouble
...
maxViewWithKey :: IntMapDouble -> Maybe ((Key, a), IntMapDouble)
maxViewWithKey t =
...
minViewWithKey :: IntMapDouble -> Maybe ((Key, a), IntMapDouble)
minViewWithKey t =
  case t of Nil -> Nothing
...
updateMax :: (a -> Maybe a) -> IntMapDouble -> IntMapDouble
...
updateMin :: (a -> Maybe a) -> IntMapDouble -> IntMapDouble
...
isProperSubmapOf :: Eq a => IntMapDouble -> IntMapDouble -> Bool
...
{- | /O(n+m)/. Is this a proper submap? (ie. a submap but not equal).
 ...
 But the following are all 'False':
  ...
  > isProperSubmapOfBy (<)  (fromList [(1,1)])       (fromList [(1,1),(2,2)])
-}
isProperSubmapOfBy :: (a -> b -> Bool) -> IntMapDouble -> IntMapDouble -> Bool
isProperSubmapOfBy predicate t1 t2
  = case submapCmp predicate t1 t2 of
      LT -> True
      _  -> False

submapCmp :: (a -> b -> Bool) -> IntMapDouble -> IntMapDouble -> Ordering
...
isSubmapOf :: Eq a => IntMapDouble -> IntMapDouble -> Bool
isSubmapOf m1 m2
  = isSubmapOfBy (==) m1 m2
...
-}
isSubmapOfBy :: (a -> b -> Bool) -> IntMapDouble -> IntMapDouble -> Bool
...
map :: (a -> b) -> IntMapDouble -> IntMapDouble
map f t
  = case t of
...
mapWithKey :: (Key -> a -> b) -> IntMapDouble -> IntMapDouble
mapWithKey f t
  = case t of
...
traverseWithKey :: Applicative t => (Key -> a -> t b) -> IntMapDouble -> t (IntMapDouble)
...
mapAccum :: (a -> b -> (a,c)) -> a -> IntMapDouble -> (a,IntMapDouble)
...
mapAccumWithKey :: (a -> Key -> b -> (a,c)) -> a -> IntMapDouble -> (a,IntMapDouble)
mapAccumWithKey f a t
  = mapAccumL f a t

-- | /O(n)/. The function @'mapAccumL'@ threads an accumulating
-- argument through the map in ascending order of keys.
mapAccumL :: (a -> Key -> b -> (a,c)) -> a -> IntMapDouble -> (a,IntMapDouble)
mapAccumL f a t
  = case t of
...
mapAccumRWithKey :: (a -> Key -> b -> (a,c)) -> a -> IntMapDouble -> (a,IntMapDouble)
...
mapKeys :: (Key->Key) -> IntMapDouble -> IntMapDouble
...
mapKeysWith :: (a -> a -> a) -> (Key->Key) -> IntMapDouble -> IntMapDouble
...
mapKeysMonotonic :: (Key->Key) -> IntMapDouble -> IntMapDouble
...
filter :: (a -> Bool) -> IntMapDouble -> IntMapDouble
filter p m
...
filterWithKey :: (Key -> a -> Bool) -> IntMapDouble -> IntMapDouble
...
partition :: (a -> Bool) -> IntMapDouble -> (IntMapDouble,IntMapDouble)
partition p m
...
partitionWithKey :: (Key -> a -> Bool) -> IntMapDouble -> (IntMapDouble,IntMapDouble)
...
mapMaybe :: (a -> Maybe b) -> IntMapDouble -> IntMapDouble
...
mapMaybeWithKey :: (Key -> a -> Maybe b) -> IntMapDouble -> IntMapDouble
...
mapEither :: (a -> Either b c) -> IntMapDouble -> (IntMapDouble, IntMapDouble)
mapEither f m
...
mapEitherWithKey :: (Key -> a -> Either b c) -> IntMapDouble -> (IntMapDouble, IntMapDouble)
...
split :: Key -> IntMapDouble -> (IntMapDouble, IntMapDouble)
split k t =
...
splitLookup :: Key -> IntMapDouble -> (IntMapDouble, Maybe a, IntMapDouble)
splitLookup k t =
  case t of Bin _ m l r | m < 0 -> if k >= 0 -- handle negative numbers.
...
foldrWithKey :: (Int -> a -> b -> b) -> b -> IntMapDouble -> b
...
foldlWithKey :: (a -> Int -> b -> a) -> a -> IntMapDouble -> a
...
keysSet :: IntMapDouble -> IntSet.IntSet
keysSet Nil = IntSet.empty
keysSet (Tip kx _) = IntSet.singleton kx
keysSet (Bin p m l r)
  | m .&. IntSet.suffixBitMask == 0 = IntSet.union (keysSet l) (keysSet r)
...
fromSet :: (Key -> a) -> IntSet.IntSet -> IntMapDouble
...
foldrFB :: (Key -> a -> b -> b) -> b -> IntMapDouble -> b
foldrFB = foldrWithKey
{-# INLINE[0] foldrFB #-}
foldlFB :: (a -> Key -> b -> a) -> a -> IntMapDouble -> a
...
fromListWith :: (a -> a -> a) -> [(Key,a)] -> IntMapDouble
fromListWith f xs
...
fromListWithKey :: (Key -> a -> a -> a) -> [(Key,a)] -> IntMapDouble
...
fromAscList :: [(Key,a)] -> IntMapDouble
fromAscList xs
...
fromAscListWith :: (a -> a -> a) -> [(Key,a)] -> IntMapDouble
...
fromAscListWithKey :: (Key -> a -> a -> a) -> [(Key,a)] -> IntMapDouble
...
fromDistinctAscList :: [(Key,a)] -> IntMapDouble
...
fromDistinctAscList (z0 : zs0) = work z0 zs0 Nada
  where
    ...
    reduce :: (Key,a) -> [(Key,a)] -> Mask -> Prefix -> IntMapDouble -> Stack a -> IntMapDouble
...
data Stack a = Push {-# UNPACK #-} !Prefix !(IntMapDouble) !(Stack a) | Nada


{--------------------------------------------------------------------
  Eq
--------------------------------------------------------------------}
instance Eq a => Eq (IntMapDouble) where
  t1 == t2  = equal t1 t2
  t1 /= t2  = nequal t1 t2

equal :: Eq a => IntMapDouble -> IntMapDouble -> Bool
...
nequal :: Eq a => IntMapDouble -> IntMapDouble -> Bool
...
instance Ord a => Ord (IntMapDouble) where
...
instance Show a => Show (IntMapDouble) where
...
{--------------------------------------------------------------------
  Join
--------------------------------------------------------------------}
join :: Prefix -> IntMapDouble -> Prefix -> IntMapDouble -> IntMapDouble
join p1 t1 p2 t2
...
--------------------------------------------------------------------}
bin :: Prefix -> Mask -> IntMapDouble -> IntMapDouble -> IntMapDouble
bin _ _ l Nil = l
bin _ _ Nil r = r
...
showTree :: Show a => IntMapDouble -> String
showTree s
...
-}
showTreeWith :: Show a => Bool -> Bool -> IntMapDouble -> String
showTreeWith hang wide t
  | hang      = (showsTreeHang wide [] t) ""
  | otherwise = (showsTree wide [] [] t) ""

showsTree :: Show a => Bool -> [String] -> [String] -> IntMapDouble -> ShowS
...
showsTreeHang :: Show a => Bool -> [String] -> IntMapDouble -> ShowS
